...
| 2:20–2:40 | Switch to ep 5. Ask "Is the drop at 11:30 the story or the stream?" Show the CDN breakdown result. | "Episode five has a drop that looks the same. The agent finds it's one CDN edge, one region, smart TVs — and hands it to streaming ops instead of recutting a scene." |
